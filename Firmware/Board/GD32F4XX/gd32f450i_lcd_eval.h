...
#ifndef GD32F450I_LCD_EVAL_H
#define GD32F450I_LCD_EVAL_H
...
void lcd_rectangle_fill(uint16_t xpos, uint16_t ypos, uint16_t width, uint16_t height, uint16_t color);
